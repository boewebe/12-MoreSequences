...
def run_test_make_less_simple_string():
    ...
    # Test 3:
    expected = '-4--3--2--1-0-1'
    actual = make_less_simple_string(-4, 1)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        rectangles = rectangles + [rectangle1]
    return rectangles
